...
namespace Ionic.Zlib
{
    ...
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        {
            bool mustWait = false;
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write()...");
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() about to EmitPendingBuffers...");

                EmitPendingBuffers(false, mustWait);
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() after EmitPendingBuffers...");
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() about to dequeue...");
                    ix = _toFill.Dequeue();
                    TraceOutput(TraceBits.WriteTake,
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() about to queue user work item...");
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() about to repeat loop...");
            }
        ...
        private void EmitPendingBuffers(bool doAll, bool mustWait)
        {
            ...
            do
            {
                ...
                do
                {
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit inner loop starting...");

                    if (Monitor.TryEnter(_toWrite, millisecondsToWait))
                    {
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit entered _toWrite lock...");
                        nextToWrite = -1;
                        try
                        {
                            if (_toWrite.Count > 0)
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit left _toWrite lock...");
                        }
                        ...
                        if (nextToWrite >= 0)
                        {
                            ...
                            {
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit out-of-order, going to requeue...");
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit waiting for compressor to signal again...");
                                    _newlyCompressedBlob.WaitOne();
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit compressor has signaled again...");
                                    firstSkip = -1;
                                }
                                else if (firstSkip == -1)
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit beginning with index=" + workitem.index + " ordinal=" + workitem.ordinal + " compressedBytesAvailable=" + workitem.compressedBytesAvailable + "...");
                            ...
                            TraceOutput(TraceBits.EmitDone,
                                        ...
                                        workitem.compressedBytesAvailable,
                                        millisecondsToWait);
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit done with index=" + workitem.index + " ordinal=" + workitem.ordinal + " compressedBytesAvailable=" + workitem.compressedBytesAvailable + "...");
...
if (Diagnostic != null) Diagnostic.WriteLine("ParallelDeflateOutputStream.Write() emit outer looping...");
