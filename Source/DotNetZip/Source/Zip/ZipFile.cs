...
#if !NETCF
            // ParallelDeflateThreshold = 512 * 1024;       // W.B. The parallel mode has a bug.  This is slower, but more robust.  See:
            ParallelDeflateThreshold = -1;                  // https://dotnetzip.codeplex.com/workitem/15126
#endif
            // workitem 7685, 9868
            _initEntriesDictionary();
