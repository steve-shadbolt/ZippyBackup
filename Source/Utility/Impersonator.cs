...
{   
    ...
    public class Impersonator : IDisposable
    {
        ...
        public Impersonator(StoredNetworkCredentials Credentials)
        {
            if (Credentials.Provided) Impersonate(Credentials.UserName, Credentials.Domain, Credentials.Password);
            // If no credentials provided, do nothing - it's not an error.
        }

        public Impersonator(System.Net.NetworkCredential Credentials)
        {
            Impersonate(Credentials.UserName, Credentials.Domain, Credentials.Password);
        }
